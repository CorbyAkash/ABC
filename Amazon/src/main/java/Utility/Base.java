...
public class Base {
	...
	public static String getObject(String Data) throws IOException {
		prop=new Properties();
		InputStream input= new FileInputStream(System.getProperty("user.dir")+"\\src\\main\\java\\TestData\\Config.properties");
		prop.load(input);
	...
	public void ExtendReportFail(String TestName, String GetName, String throwable) throws IOException {
		...
		logger.addScreenCaptureFromPath("C:\\eclipse\\Amazon\\Screenshot\\"+TestName+".png");
		extend.flush();
